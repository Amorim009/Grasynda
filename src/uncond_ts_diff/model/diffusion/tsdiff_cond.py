...
from src.uncond_ts_diff.arch import BackboneModel
from src.uncond_ts_diff.model.diffusion._base import TSDiffBase
from src.uncond_ts_diff.model.diffusion._base import PREDICTION_INPUT_NAMES
from src.uncond_ts_diff.utils import get_lags_for_freq
...
class TSDiffCond(TSDiffBase):
    ...
    def _extract_features(self, data):
        ...
        scaled_context, scale = self._unpack_scaler_output(
            self.scaler(context, context_observed)
        )
        features = []
